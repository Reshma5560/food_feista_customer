                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Text("12321", style: TextStyle(color: Colors.transparent)),
                    ],
                  ),
                ),
                Padding(
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  decoration:
                                                      BoxDecoration(color: Theme.of(context).primaryColor, borderRadius: BorderRadius.circular(5.r)),
                                                  child: InkWell(
                                                    onTap: () {
                                                ...
                                                Container(
                                                  ...
                                                  child: InkWell(
                                                                          ...
                                                                          Expanded(
                                                                            child: AppButton(
                                                                              ...
                                                                              onPressed: () {
                                                                                ...
                                                                                AuthRepository()
                                                                                    .removeAddressByIdApiCall(addressId: item.id)
                                                                                    .then((value) {
                                                                                  Get.back();
                                                                                });
                                                                              },
                                                    ...
                                                    child: Icon(Icons.delete, size: 14.sp, color: Theme.of(context).primaryColor),
                                                  ),
                                                ),
                                              ],
                                            ),
