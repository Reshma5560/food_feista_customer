...
class CartScreen extends StatelessWidget {
                                          ...
                                          return Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              gradient: LinearGradient(
                                                  ...
                                                  colors: [AppColors.white, Theme.of(context).colorScheme.background]),
                                                          ...
                                                          children: [
                                                            Text(
                                                              /*  item.totalPrice?.value == double.parse(item.price ?? "0")
                                                                    ? */
                                                              "₹${item.subtotal?.toString()}" /*: "₹${item.totalPrice?.value}"*/,
                                ...
                                ? ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      return InkWell(
                                        ...
                                        onTap: () {
                                          if (double.parse(con.cartData.value.data?.totalPrice ?? "0") <= con.couponItemData[index].minPurchase!) {
                                            toast("Your order must be more then ₹${con.couponItemData[index].minPurchase}");
                                          } else {
                                            if (con.selectedIndex.value != (-1)) {
                                              con.totalAmount.value =
                                                  con.totalAmount.value + con.couponItemData[con.selectedIndex.value].maxDiscount!;
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Obx(
                                              () => Text(
                                                "₹${con.cartData.value.data?.totalPrice}",
                                      ...
                                      onPressed: () {
                                        Get.toNamed(
                                          ...
                                          arguments: {
                                            ...
                                            "payable_amount": con.totalAmount.value.toString(),
                                          },
                                        );
                                      },
  ...
  addItem(BuildContext context, {required CartDetail item}) {
