                                    ...
                                    child: Obx(
                                      () => Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border:
                                              Border.all(color: con.selectedIndex.value == index ? Theme.of(context).primaryColor : AppColors.grey),
                                    ...
                                    child: Obx(
                                      () => Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border:
                                              Border.all(color: con.selectedIndex2.value == index ? Theme.of(context).primaryColor : AppColors.grey),
                                          borderRadius: BorderRadius.circular(15),
                                        ),
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
