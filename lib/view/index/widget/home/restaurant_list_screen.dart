                            ...
                            child: Obx(
                              () => Container(
                                ...
                                child: Text(
                                  "Veg",
                                  style: TextStyle(
                                    fontWeight: con.selectVeg.value != 0
                                        ? FontWeight.w500
                                        : FontWeight.w400,
                                    color: con.selectVeg.value != 0
                                        ? AppColors.white
                          ...
                          InkWell(
                            ...
                            child: Obx(
                              () => Container(
                                padding: const EdgeInsets.all(8),
                                decoration: BoxDecoration(
                                  color: con.selectNonVeg.value != 0
                                      ? Theme.of(Get.context!).primaryColor
                                      : AppColors.white,
                                  border: Border.all(
                                    color: con.selectNonVeg.value != 0
                                ...
                                child: Text(
                                  "Non-Veg",
                                  style: TextStyle(
                                    fontWeight: con.selectNonVeg.value != 0
                                        ? FontWeight.w500
                                        : FontWeight.w400,
                                    color: con.selectNonVeg.value != 0
                                        ? AppColors.white
                          ...
                          InkWell(
                            ...
                            child: Obx(
                              () => Container(
                                padding: const EdgeInsets.all(8),
                                decoration: BoxDecoration(
                                  color: con.selectPureVeg.isTrue
                                      ? Theme.of(Get.context!).primaryColor
                                      : AppColors.white,
                                  border: Border.all(
                                    color: con.selectPureVeg.isTrue
                                ...
                                child: Text(
                                  "Pure Veg",
                                  style: TextStyle(
                                    fontWeight: con.selectPureVeg.isTrue
                                        ? FontWeight.w500
                                        : FontWeight.w400,
                                    color: con.selectPureVeg.isTrue
                                        ? AppColors.white
                        ...
                        child: Obx(
                          () => Container(
                            ...
                            child: Text(
                              "Near by me",
                              style: TextStyle(
                                fontWeight: con.isNearByMe.isTrue
                                    ? FontWeight.w500
                                    : FontWeight.w400,
                                color: con.isNearByMe.isTrue
                                    ? AppColors.white
          ...
          child: Obx(
            () => ChoiceChip(
              ...
              label: Text(
                item.cuisineName ?? "",
                style: TextStyle(
                  fontWeight: con.selectedChoice.contains(item.id)
                      ? FontWeight.w500
                      : FontWeight.w400,
                  color: con.selectedChoice.contains(item.id)
                      ? AppColors.white
                      : null,
                ),
              ),
