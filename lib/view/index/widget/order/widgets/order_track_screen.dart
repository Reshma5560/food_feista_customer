  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Obx(
        () => (con.orderTrackModel.value.data?.orderStatus?.statusName ==
                    "Order Delivered" &&
                con.orderTrackModel.value.data?.comments == null)
                                ...
                                () => AppButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (con.ratingForOrderValue.value == 0.0) {
                                      toast(
                                          "Please select Order rating value minimum 1");
                                    } else if (con
                                            .ratingForDeliveryMenValue.value ==
                                        0.0) {
                                      toast(
                                          "Please select deliverymen rating value minimum 1");
                                    }

                                    if (con.isValid.isFalse &&
                                        con.ratingForOrderValue.value != 0.0 &&
                                        con.ratingForDeliveryMenValue.value !=
                                            0.0) {
                                      await DesktopRepository()
                                        ...
                                        params: {
                                          ...
                                          "order_rating": con
                                              .ratingForOrderValue.value
                                              .toString(),
                                          "deliveryman_rating": con
                                              .ratingForDeliveryMenValue.value
                                              .toString(),
                                        },
                                      );
              ...
              ? Row(
                  ...
                  children: [
                    ...
                    RatingBar.builder(
                      ...
                      itemSize: 18,
                      initialRating:
                          double.parse(item!.comments!.rating.toString()),
