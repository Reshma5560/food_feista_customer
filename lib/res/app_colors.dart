...
class AppColors {
  ...
  static Color kBackgroundColor = const Color(0xffFFF8EB); //0xFFffe9e9);
  ...
  static Color nonVegRed = const Color(0xffb83907);
  ...
  static Color yellow = const Color(0xffFFC05D);
