...
class AppTextField extends StatelessWidget {
  ...
  Widget myTextFormField(BuildContext context) {
    return TextFormField(
      ...
      style: style ?? TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w500, color: titleTextColor ?? Theme.of(context).primaryColor),
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: suffixIcon != null
            ...
            : null,
        hintText: hintText,
        hintStyle: hintStyle ?? TextStyle(fontSize: 11.sp, fontWeight: FontWeight.w400, color: AppColors.hintColor),
        enabledBorder: enabledBorder ??
            OutlineInputBorder(
                borderRadius: BorderRadius.all(Radius.circular(14.r)),
                borderSide: BorderSide(color: showError == false ? AppColors.white : Theme.of(context).colorScheme.error)),
        border: border ?? OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(14.r)), borderSide: BorderSide(color: AppColors.white)),
        focusedBorder: focusedBorder ??
            OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(14.r)), borderSide: BorderSide(color: AppColors.white)),
