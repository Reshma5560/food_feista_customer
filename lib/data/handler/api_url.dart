...
class ApiUrls {
  ...
  /// Socket
  // static String socketUrl = AppEnvironment().getSocketURL();

  //? Auth Api's
  static String checkUserStatus = "auth/exists-user?mobile_no=";
  ...
  static String getGroupChat(dynamic groupID) => "tip/$groupID";

  static String getTipReactions(dynamic tipId) => "tip/reactions/$tipId";
}
